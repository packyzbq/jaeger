...
ifeq ($(GOARCH), s390x)
	...
	GOARCH=${GOARCH} $(GOBUILD) -o ./cmd/agent/agent-$(GOOS) $(BUILD_INFO) ./cmd/agent/main.go
endif
...
ifeq ($(GOARCH), s390x)
	...
	GOARCH=${GOARCH} $(GOBUILD) -tags ui -o ./cmd/query/query-$(GOOS) $(BUILD_INFO) ./cmd/query/main.go
endif
...
ifeq ($(GOARCH), s390x)
	...
	GOARCH=${GOARCH} $(GOBUILD) -o ./cmd/collector/collector-$(GOOS) $(BUILD_INFO) ./cmd/collector/main.go
endif
